...
export function JoinTripModal({ open, onClose }: Props) {
  ...
  function handleClose() {
    if (loading) return   // prevent closing during network call
    setCode('')
    setError(null)
    setInfo(null)
    onClose()
  ...
  return (
    <>
      {/* Full-screen travel loader while server action is running */}
      <TravelLoader visible={loading} />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                autoFocus
                disabled={loading}
                className="w-full pl-12 pr-4 py-4 text-center font-mono text-2xl font-black tracking-[0.3em] rounded-2xl border-2 border-gray-200 focus:outline-none focus:border-violet-400 bg-gray-50 uppercase placeholder:text-gray-300 placeholder:tracking-[0.2em] placeholder:font-normal transition-colors disabled:opacity-50"
              />
